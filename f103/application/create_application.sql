...
,p_owner=>nvl(wwv_flow_application_install.get_schema,'SKORAM')
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Customer Tracker')
...
,p_authentication_id=>wwv_flow_api.id(17824033086465266520)
...
,p_security_scheme=>wwv_flow_api.id(15990379931319317545)
...
,p_substitution_value_04=>'Customer Tracker'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20200116095349'
