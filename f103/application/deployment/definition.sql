...
wwv_flow_api.create_install(
 p_id=>wwv_flow_api.id(17817343456864234187)
...
,p_configuration_message=>'Customer Tracker Installation. You can configure the following attributes of your application.'
,p_build_options_message=>'Customer Tracker Installation. You can choose to include the following build options.'
,p_validation_message=>'Customer Tracker Installation. The following validations will be performed to ensure your system is compatible with this application.'
,p_install_message=>'Customer Tracker Installation. Please confirm that you would like to install this application''s supporting objects.'
...
,p_deinstall_success_message=>'Customer Tracker deinstallation complete.'
...
'drop table eba_cust_flex_registry        cascade constraints;',
'drop table eba_cust_flex_page_map        cascade constraints;',
'drop table eba_cust_flex_static_lovs     cascade constraints;',
...
||'E_DATA:EBA_CUST_TZ_INIT:EBA_CUST_CUSTOMERS_V:EBA_CUST_SEQ:EBA_CUST_FW:EBA_CUST_FLEX_STATIC_LOVS:EBA_CUST_FLEX_REGISTRY:EBA_CUST_FLEX_FW:EBA_CUST_FLEX_PAGE_MAP:EBA_CUST_CLICKS:EBA_CUST_VERIFICATIONS:EBA_CUST_TYPE:EBA_CUST_USE_CASE:EBA_CUST_COMPETITORS'
||':EBA_CUST_CUST_COMPETITOR_REF:EBA_CUST_CUST_PARTNER_REF:EBA_CUST_IMPL_PARTNERS:EBA_CUST_PRODUCT_FAMILIES:EBA_CUST_ACTIVITIES:EBA_CUST_ACTIVITY_FILES:EBA_CUST_ACTIVITY_REF:EBA_CUST_ACTIVITY_TYPES:EBA_CUST_FEEDBACK_TYPES:EBA_CUST_FEEDBACK:EBA_CUST_EMAI'
||'L_LOG:EBA_CUST_EMAIL:EBA_CUST_ISSUE_STATUSES:EBA_CUST_ISSUES'
