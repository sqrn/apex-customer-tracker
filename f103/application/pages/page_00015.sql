...
,p_last_upd_yyyymmddhh24miss=>'20190325132131'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(16332961508833185605)
,p_plug_name=>'Search'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(16332962913674185610)
,p_plug_name=>'Search'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(16332963119131185611)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(16332961905026185607)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(16332963119131185611)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(16332961729024185605)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(16332963730258185615)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16332962130583185607)
,p_name=>'P15_ROWS'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(16332961508833185605)
,p_item_default=>'100'
,p_prompt=>'Results'
,p_source=>'100'
...
,p_named_lov=>'ROWS'
,p_lov=>'.'||wwv_flow_api.id(16332963816925185617)||'.'
,p_cSize=>64
,p_cMaxlength=>4000
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16332962507414185609)
,p_name=>'P15_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(16332961508833185605)
,p_prompt=>'Search'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(16332962727972185609)
,p_name=>'P15_STATUS'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(16332961508833185605)
,p_prompt=>'Status'
