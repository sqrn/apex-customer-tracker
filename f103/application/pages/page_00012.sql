...
'    </ul>',
'</p>'))
,p_last_upd_yyyymmddhh24miss=>'20181102170745'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14674192703383458171)
...
,p_plug_template=>wwv_flow_api.id(14882974461156818403)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14750269699481245989)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14954569909013831633)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(362125841655092509)
,p_name=>'User Counts'
,p_parent_plug_id=>wwv_flow_api.id(14954569909013831633)
...
'order by 1'))
,p_ajax_enabled=>'Y'
,p_query_row_template=>wwv_flow_api.id(14882983222452818420)
,p_query_num_rows=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(362125899781092510)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(362126054026092511)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(362126123591092512)
,p_query_column_id=>3
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(362126274390092513)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14750269585427245988)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17830659537442948644)
...
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(17830656931902947078)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15867827368366838624)
...
,p_plug_new_grid_column=>false
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(15867821236383837504)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(14882992268104818439)
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(16370512220773924769)
...
,p_plug_new_grid_column=>false
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(16370151920033896105)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(14882992268104818439)
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17825092577146408497)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17825121373483878468)
...
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(17825093987675416374)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(14882992268104818439)
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18028189078407782764)
,p_plug_name=>'Logging'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hiddenOverflow'
,p_component_template_options=>'#DEFAULT#:u-colors'
,p_plug_template=>wwv_flow_api.id(14882979167825818413)
...
,p_plug_new_grid_column=>false
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(18759368777675608968)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(14882992268104818439)
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14674192916196461867)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(14674192703383458171)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14674193127278465140)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(17834887323460229398)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(16000379902253054767)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(14978987517481418696)
...
'   c integer;',
'begin',
'select count(*) into c from eba_cust_flex_registry where nvl(ASSIGNED_YN,''N'') = ''Y'';',
':CNT_01 := c;',
