...
,p_last_upd_yyyymmddhh24miss=>'20190322145749'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14304373389065369415)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(14304373450019369415)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14304373805832369421)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14304374269197369423)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14304374602942369423)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14304375071928369424)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14304375456855369424)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14304385843610369425)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14301590006170718063)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14347171429433837618)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14347175684322844161)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(14304386884568370175)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14301589044829718053)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(14304373389065369415)
,p_button_name=>'RESET'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14301589172515718054)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(14301589244766718055)
,p_name=>'Refresh IRR on Add Close'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(14301589172515718054)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(14301589337564718056)
,p_event_id=>wwv_flow_api.id(14301589244766718055)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(14304373389065369415)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(14347218655542873002)
,p_name=>'on dialog close refresh report'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(14304373389065369415)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(14347219083316873003)
,p_event_id=>wwv_flow_api.id(14347218655542873002)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(1641383187930288260)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1641383512130288260)
,p_event_id=>wwv_flow_api.id(1641383187930288260)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1641384070188288261)
,p_event_id=>wwv_flow_api.id(1641383187930288260)
,p_event_result=>'TRUE'
