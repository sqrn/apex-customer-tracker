...
,p_last_upd_yyyymmddhh24miss=>'20190322144611'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15912508510813237445)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15409653686970344899)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(15912508510813237445)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15409652874224344898)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15409652544701344898)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15409653328041344898)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(15409656377664344908)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(357991553632317636)
,p_name=>'CNX'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(15409653686970344899)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(357991647985317637)
,p_event_id=>wwv_flow_api.id(357991553632317636)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15409655134310344906)
...
,p_process_when_button_id=>wwv_flow_api.id(15409653328041344898)
,p_process_success_message=>'Sample data reset.'
,p_security_scheme=>wwv_flow_api.id(15699467515544778094)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15409655498707344908)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(15409652874224344898)
,p_process_success_message=>'Sample Data Removed'
,p_security_scheme=>wwv_flow_api.id(15699467515544778094)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15409655912576344908)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(15409652544701344898)
