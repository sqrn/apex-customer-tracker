...
,p_last_upd_yyyymmddhh24miss=>'20171009062407'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14396414428777507120)
...
,p_plug_query_row_template=>wwv_flow_api.id(22416701431041652550)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14396414620163507120)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14396414810014507121)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(14396414620163507120)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(14396415036870507122)
...
,p_process_when_button_id=>wwv_flow_api.id(14396414810014507121)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(14396415205665507123)
