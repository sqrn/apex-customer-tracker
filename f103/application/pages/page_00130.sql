...
,p_last_upd_yyyymmddhh24miss=>'20190325141117'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1007831470228613117)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2892535908962524409)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(362634875650796218)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(1007831470228613117)
,p_button_name=>'SAVE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(362634423675796217)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(362644621720796241)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(362635591887796218)
,p_name=>'P130_AC_ENABLED'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2892535908962524409)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(362635942674796220)
...
,p_lov=>'.'||wwv_flow_api.id(362644990562796244)||'.'
,p_field_template=>wwv_flow_api.id(290501484459896415)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(362636340473796220)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(362636702924796224)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(362639054660796237)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(362639501280796238)
,p_event_id=>wwv_flow_api.id(362639054660796237)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(362640005032796238)
,p_event_id=>wwv_flow_api.id(362639054660796237)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(362641317962796239)
,p_name=>'APPLY CHANGES WHEN AC ENABLED'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(362634875650796218)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(362641802689796239)
,p_event_id=>wwv_flow_api.id(362641317962796239)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(362642229102796239)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(362642734645796239)
,p_event_id=>wwv_flow_api.id(362642229102796239)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(362643219803796240)
,p_event_id=>wwv_flow_api.id(362642229102796239)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(362643597066796240)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(362644109407796240)
,p_event_id=>wwv_flow_api.id(362643597066796240)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SUBMIT_PAGE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(362640480329796238)
,p_name=>'Cancel Dialog'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(362634423675796217)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(362640927010796238)
,p_event_id=>wwv_flow_api.id(362640480329796238)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(362637871108796236)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(362638288375796236)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(362638654959796237)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(362637480747796236)
