...
,p_last_upd_yyyymmddhh24miss=>'20190322150725'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(509169968088122617)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(509170053949122618)
,p_region_id=>wwv_flow_api.id(509169968088122617)
,p_chart_type=>'bar'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(509170185911122619)
,p_chart_id=>wwv_flow_api.id(509170053949122618)
,p_seq=>10
,p_name=>'Geography'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(509170357982122621)
,p_chart_id=>wwv_flow_api.id(509170053949122618)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(509170249533122620)
,p_chart_id=>wwv_flow_api.id(509170053949122618)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(509170415252122622)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(509170502211122623)
,p_region_id=>wwv_flow_api.id(509170415252122622)
,p_chart_type=>'bar'
,p_animation_on_display=>'none'
,p_animation_on_data_change=>'none'
,p_orientation=>'vertical'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(509170640728122624)
,p_chart_id=>wwv_flow_api.id(509170502211122623)
,p_seq=>10
,p_name=>'Geography'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(509170737758122625)
,p_chart_id=>wwv_flow_api.id(509170502211122623)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(509170831833122626)
,p_chart_id=>wwv_flow_api.id(509170502211122623)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_type=>'decimal'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20270679604956807095)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20270679923223807104)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20270681181868807107)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20270682305885807110)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(20270682740832807111)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(20270683120322807111)
,p_button_sequence=>1000
,p_button_plug_id=>wwv_flow_api.id(20270682740832807111)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20270680321715807104)
,p_name=>'P100_CATEGORY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(20270679923223807104)
,p_item_default=>'0'
,p_prompt=>'Category'
,p_source=>'0'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(20270680737680807107)
,p_name=>'P100_GEO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(20270679923223807104)
,p_prompt=>'Geography'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(20270686195752807122)
,p_name=>'cat'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(20270687760062807123)
,p_event_id=>wwv_flow_api.id(20270686195752807122)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(20270682305885807110)
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(20270688234062807123)
,p_event_id=>wwv_flow_api.id(20270686195752807122)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(20270679604956807095)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(20270683857462807117)
,p_name=>'geo'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(20270685345039807121)
,p_event_id=>wwv_flow_api.id(20270683857462807117)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(20270685832893807122)
,p_event_id=>wwv_flow_api.id(20270683857462807117)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
