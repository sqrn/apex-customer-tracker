...
,p_last_upd_yyyymmddhh24miss=>'20190325144324'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1636942266364321838)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17025397899758246129)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17025402721088246152)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17025401969787246150)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(1636942266364321838)
,p_button_name=>'SAVE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17025402360593246151)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17025401137108246146)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17025401584490246150)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17025398262331246135)
,p_name=>'P103_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(17025397899758246129)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17025398639074246137)
,p_name=>'P103_STATUS'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(17025397899758246129)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17025399493919246141)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17025400443753246142)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17025403171161246152)
,p_name=>'P103_CREATED'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(17025402721088246152)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17025404038910246154)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17025404942733246155)
,p_name=>'P103_UPDATED'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(17025402721088246152)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17025405884802246156)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(17025407146981246166)
...
,p_associated_item=>wwv_flow_api.id(17025398639074246137)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(17025407518111246168)
...
,p_when_button_pressed=>wwv_flow_api.id(17025401584490246150)
,p_associated_item=>wwv_flow_api.id(17025398639074246137)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(1636942465629321840)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(17025401137108246146)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1636942559199321841)
,p_event_id=>wwv_flow_api.id(1636942465629321840)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17025407848824246168)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17025408250930246174)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17025408595705246174)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_process_when_button_id=>wwv_flow_api.id(17025401584490246150)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(1636942393638321839)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17025409039477246174)
,p_process_sequence=>40
