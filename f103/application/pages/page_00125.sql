...
,p_last_upd_yyyymmddhh24miss=>'20190325141100'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18158747780099826911)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18158748331651826917)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18158748602494826917)
,p_plug_name=>'Data Load Source'
,p_parent_plug_id=>wwv_flow_api.id(18158748331651826917)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18158756824306826935)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18158866406998787695)
...
'',
'<li>Ensure the Categories and Status values match the categories defined in this customer tracker application.  Administrators of this application can define categories and status values.  The current values are displayed on this page for reference.<'
||'/li>',
'',
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(18158873915668793002)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18158874210715793004)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18158874615552793006)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18158875007915793007)
,p_query_column_id=>3
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(18158876088351839586)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(18158878644183841401)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18158879766722841406)
,p_query_column_id=>1
,p_column_alias=>'TYPE'
,p_column_display_sequence=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18158878908539841404)
,p_query_column_id=>2
,p_column_alias=>'DESCRIPTION'
,p_column_display_sequence=>2
,p_column_heading=>'Description'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18158879350817841406)
,p_query_column_id=>3
,p_column_alias=>'STATUS'
,p_column_display_sequence=>3
,p_column_heading=>'Status'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(18158881088923842565)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18158881342477842567)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18158881715857842567)
,p_query_column_id=>2
,p_column_alias=>'DESCRIPTION'
,p_column_display_sequence=>2
,p_column_heading=>'Description'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18158882101361842568)
,p_query_column_id=>3
,p_column_alias=>'STATUS'
,p_column_display_sequence=>3
,p_column_heading=>'Status'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18158944558615864396)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(18158747780099826911)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18158749476550826920)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(18158748331651826917)
,p_button_name=>'NEXT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18158749050552826918)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(18158763263915826942)
,p_branch_action=>'f?p=&APP_ID.:126:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(18158749476550826920)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18158749911557826921)
,p_name=>'P125_IMPORT_FROM'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(18158748602494826917)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18158750224077826923)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18158751612500826925)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18158752568180826928)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18158753471840826929)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18158754367034826930)
...
,p_lov=>'.'||wwv_flow_api.id(18157224269357599186)||'.'
,p_field_template=>wwv_flow_api.id(14882996027614818454)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_escape_on_http_input=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18158755207149826932)
...
,p_lov=>'.'||wwv_flow_api.id(18157225879330599194)||'.'
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(14882996027614818454)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18158756477104826933)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18158757298573826935)
,p_name=>'P125_CURRENCY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(18158756824306826935)
,p_item_default=>'$'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18158758251588826936)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18158759133447826937)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18158876344135839589)
,p_name=>'P125_SAMPLE_DATA'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(18158876088351839586)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18169306281536936645)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(18169307569469936658)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(18158751218160826924)
...
,p_when_button_pressed=>wwv_flow_api.id(18158749476550826920)
,p_associated_item=>wwv_flow_api.id(18158750224077826923)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(17946368891870408784)
...
,p_validation_condition_type=>'VAL_OF_ITEM_IN_COND_EQ_COND2'
,p_when_button_pressed=>wwv_flow_api.id(18158749476550826920)
,p_associated_item=>wwv_flow_api.id(18158756477104826933)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(18158759962443826937)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18158760950342826939)
,p_event_id=>wwv_flow_api.id(18158759962443826937)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18158760451990826938)
,p_event_id=>wwv_flow_api.id(18158759962443826937)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(18158761373752826939)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18158762357749826941)
,p_event_id=>wwv_flow_api.id(18158761373752826939)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18158761801133826940)
,p_event_id=>wwv_flow_api.id(18158761373752826939)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18169307820788936661)
,p_event_id=>wwv_flow_api.id(18158761373752826939)
,p_event_result=>'FALSE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
,p_affected_region_id=>wwv_flow_api.id(18158866406998787695)
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18169307785570936660)
,p_event_id=>wwv_flow_api.id(18158761373752826939)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(18169138879433877449)
,p_name=>'Set copy and paste textarea with sample data'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(18158944558615864396)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18169140700283877454)
,p_event_id=>wwv_flow_api.id(18169138879433877449)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18169139252612877452)
,p_event_id=>wwv_flow_api.id(18169138879433877449)
,p_event_result=>'TRUE'
,p_action_sequence=>20
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18169140205419877454)
,p_event_id=>wwv_flow_api.id(18169138879433877449)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18169141228291877454)
,p_event_id=>wwv_flow_api.id(18169138879433877449)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18169139778348877453)
,p_event_id=>wwv_flow_api.id(18169138879433877449)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(18169306386527936646)
,p_name=>'set orig copy paste value and submit'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(18158749476550826920)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18169306453037936647)
,p_event_id=>wwv_flow_api.id(18169306386527936646)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
begin
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18169306562154936648)
,p_event_id=>wwv_flow_api.id(18169306386527936646)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18169306609359936649)
,p_event_id=>wwv_flow_api.id(18169306386527936646)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(18169307936108936662)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18169307992925936663)
,p_event_id=>wwv_flow_api.id(18169307936108936662)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(18158762834466826941)
...
,p_process_when_button_id=>wwv_flow_api.id(18158749476550826920)
);
end;
/
