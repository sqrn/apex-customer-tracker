...
,p_last_upd_yyyymmddhh24miss=>'20190322145108'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1121403507398278447)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(1121403635458278448)
,p_region_id=>wwv_flow_api.id(1121403507398278447)
,p_chart_type=>'bar'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(1345078675102282799)
,p_chart_id=>wwv_flow_api.id(1121403635458278448)
,p_seq=>10
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1345078727516282800)
,p_chart_id=>wwv_flow_api.id(1121403635458278448)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1345078820434282801)
,p_chart_id=>wwv_flow_api.id(1121403635458278448)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1345078990721282802)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(1345079011107282803)
,p_region_id=>wwv_flow_api.id(1345078990721282802)
,p_chart_type=>'bar'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
,p_orientation=>'vertical'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(1345079144797282804)
,p_chart_id=>wwv_flow_api.id(1345079011107282803)
,p_seq=>10
,p_name=>'Asset Commitment'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1345079319871282806)
,p_chart_id=>wwv_flow_api.id(1345079011107282803)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_type=>'decimal'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1345079280016282805)
,p_chart_id=>wwv_flow_api.id(1345079011107282803)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15795647141906472368)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15795705280007616768)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15795706113755617952)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15795877624581799445)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15868287014179646720)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15795722318821670039)
,p_button_sequence=>1000
,p_button_plug_id=>wwv_flow_api.id(15795647141906472368)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15795706397945617953)
,p_name=>'P86_CATEGORY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(15795706113755617952)
,p_item_default=>'0'
,p_prompt=>'Category'
,p_source=>'0'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15897699945518686378)
,p_name=>'P86_GEO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(15795706113755617952)
,p_prompt=>'Geography'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15897702733387743854)
,p_name=>'cat'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15897704039872746553)
,p_event_id=>wwv_flow_api.id(15897702733387743854)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(15868287014179646720)
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15897706396406757408)
,p_event_id=>wwv_flow_api.id(15897702733387743854)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(15795705280007616768)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15897704336229750915)
,p_name=>'geo'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15897705657042753691)
,p_event_id=>wwv_flow_api.id(15897704336229750915)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15897706053449755296)
,p_event_id=>wwv_flow_api.id(15897704336229750915)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
