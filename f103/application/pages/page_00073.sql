...
,p_last_upd_yyyymmddhh24miss=>'20190917145409'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1679887407626887817)
,p_plug_name=>'Buttons'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14839092211566783459)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14839093608652783464)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14839091811480783458)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(1679887407626887817)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14839092001775783459)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(14839095015983783471)
,p_branch_action=>'f?p=&APP_ID.:74:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(14839092001775783459)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14839092401853783459)
,p_name=>'P73_ROLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(14839092211566783459)
,p_item_default=>'2'
,p_prompt=>'Role'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14839092633338783462)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14839093823235783464)
,p_name=>'P73_USERNAME_FORMAT1'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(14839093608652783464)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(14839094610031783467)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(1679887572194887818)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(14839091811480783458)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1679887670799887819)
,p_event_id=>wwv_flow_api.id(1679887572194887818)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(14839094731628783468)
...
,p_process_when_button_id=>wwv_flow_api.id(14839092001775783459)
);
end;
/
