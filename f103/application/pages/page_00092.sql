...
,p_last_upd_yyyymmddhh24miss=>'20190322145704'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1129702818254361825)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(1129702908510361826)
,p_region_id=>wwv_flow_api.id(1129702818254361825)
,p_chart_type=>'bar'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(1129703004371361827)
,p_chart_id=>wwv_flow_api.id(1129702908510361826)
,p_seq=>10
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1129703175207361828)
,p_chart_id=>wwv_flow_api.id(1129702908510361826)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(1129703244273361829)
,p_chart_id=>wwv_flow_api.id(1129702908510361826)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15893821874590831685)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15893822841898836081)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15897707181000774000)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(15893821874590831685)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15893823152327836087)
,p_name=>'P92_CATEGORY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(15893822841898836081)
,p_item_default=>'0'
,p_prompt=>'Category'
,p_source=>'0'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15897697729184648130)
,p_name=>'P92_GEO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(15893822841898836081)
,p_prompt=>'Geography'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15893992153333156876)
,p_name=>'prod counts'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1129703490150361831)
,p_event_id=>wwv_flow_api.id(15893992153333156876)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(1129702818254361825)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15897698297945667054)
,p_name=>'geo'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1129703384486361830)
,p_event_id=>wwv_flow_api.id(15897698297945667054)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
