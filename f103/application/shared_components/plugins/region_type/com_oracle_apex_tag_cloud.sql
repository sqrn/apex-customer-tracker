...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(18737326455048798348)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(680079849340502734)
,p_plugin_id=>wwv_flow_api.id(18737326455048798348)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(680080270227502734)
,p_plugin_id=>wwv_flow_api.id(18737326455048798348)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(680080657322502734)
,p_plugin_id=>wwv_flow_api.id(18737326455048798348)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(680082877699502737)
,p_plugin_id=>wwv_flow_api.id(18737326455048798348)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(680083531420502738)
,p_plugin_id=>wwv_flow_api.id(18737326455048798348)
