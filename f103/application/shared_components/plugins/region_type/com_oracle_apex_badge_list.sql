...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(15645308555229913909)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1183355098139305671)
,p_plugin_id=>wwv_flow_api.id(15645308555229913909)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1183355496680305672)
,p_plugin_id=>wwv_flow_api.id(15645308555229913909)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1183355970381305673)
,p_plugin_id=>wwv_flow_api.id(15645308555229913909)
,p_attribute_scope=>'COMPONENT'
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(1183363515024305679)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1183356348997305674)
,p_plugin_id=>wwv_flow_api.id(15645308555229913909)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1183356766827305674)
,p_plugin_id=>wwv_flow_api.id(15645308555229913909)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1183357660087305675)
,p_plugin_attribute_id=>wwv_flow_api.id(1183356766827305674)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1183358130079305675)
,p_plugin_attribute_id=>wwv_flow_api.id(1183356766827305674)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1183358687411305676)
,p_plugin_attribute_id=>wwv_flow_api.id(1183356766827305674)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1183359105266305676)
,p_plugin_attribute_id=>wwv_flow_api.id(1183356766827305674)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1183359596954305676)
,p_plugin_attribute_id=>wwv_flow_api.id(1183356766827305674)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1183360112391305676)
,p_plugin_attribute_id=>wwv_flow_api.id(1183356766827305674)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1183357164831305674)
,p_plugin_attribute_id=>wwv_flow_api.id(1183356766827305674)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1183360602988305677)
,p_plugin_id=>wwv_flow_api.id(15645308555229913909)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1183361068038305677)
,p_plugin_attribute_id=>wwv_flow_api.id(1183360602988305677)
,p_display_sequence=>0
,p_display_value=>'Small'
,p_return_value=>'S'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1183361503253305677)
,p_plugin_attribute_id=>wwv_flow_api.id(1183360602988305677)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1183362055950305678)
,p_plugin_attribute_id=>wwv_flow_api.id(1183360602988305677)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1183362537960305678)
,p_plugin_attribute_id=>wwv_flow_api.id(1183360602988305677)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1183363057493305678)
,p_plugin_attribute_id=>wwv_flow_api.id(1183360602988305677)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1183363515024305679)
,p_plugin_id=>wwv_flow_api.id(15645308555229913909)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1183363915255305679)
,p_plugin_attribute_id=>wwv_flow_api.id(1183363515024305679)
,p_display_sequence=>10
,p_display_value=>'Default'
,p_return_value=>'BOX'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1183364922780305679)
,p_plugin_attribute_id=>wwv_flow_api.id(1183363515024305679)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1183364485267305679)
,p_plugin_attribute_id=>wwv_flow_api.id(1183363515024305679)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1183365416776305680)
,p_plugin_id=>wwv_flow_api.id(15645308555229913909)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1183365815487305680)
,p_plugin_attribute_id=>wwv_flow_api.id(1183365416776305680)
,p_display_sequence=>10
,p_display_value=>'Yes'
,p_return_value=>'Y'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1183366356953305680)
,p_plugin_attribute_id=>wwv_flow_api.id(1183365416776305680)
,p_display_sequence=>20
,p_display_value=>'No'
,p_return_value=>'N'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1183366851907305681)
,p_plugin_id=>wwv_flow_api.id(15645308555229913909)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(1183369987107305692)
,p_plugin_id=>wwv_flow_api.id(15645308555229913909)
,p_name=>'SOURCE_SQL'
