...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(14885952908669650852)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(75946519292654634)
,p_plugin_id=>wwv_flow_api.id(14885952908669650852)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(75946922586654634)
,p_plugin_id=>wwv_flow_api.id(14885952908669650852)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(75947285494654634)
,p_plugin_id=>wwv_flow_api.id(14885952908669650852)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(75947695984654634)
,p_plugin_id=>wwv_flow_api.id(14885952908669650852)
,p_attribute_scope=>'COMPONENT'
