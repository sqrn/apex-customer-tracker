...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(14898490633546312857)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(75993183030663352)
,p_plugin_id=>wwv_flow_api.id(14898490633546312857)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(75993610306663353)
,p_plugin_id=>wwv_flow_api.id(14898490633546312857)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(75995189937663355)
,p_plugin_id=>wwv_flow_api.id(14898490633546312857)
,p_name=>'SOURCE_SQL'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(75995865118663355)
,p_plugin_id=>wwv_flow_api.id(14898490633546312857)
