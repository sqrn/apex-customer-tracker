...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(33771940665522373836)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(75996605859665267)
,p_plugin_id=>wwv_flow_api.id(33771940665522373836)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(75996971941665267)
,p_plugin_id=>wwv_flow_api.id(33771940665522373836)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(75997383023665267)
,p_plugin_id=>wwv_flow_api.id(33771940665522373836)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(75998238173665269)
,p_plugin_id=>wwv_flow_api.id(33771940665522373836)
